/**
 * En una expresión regular, indica la utilidad del campo .source.
 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado regex en JS.' + newline + 'Ejercicio 4';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `<h4>En una expresión regular, indica la utilidad del campo .source` +
            newline + `Diferencia con toString()</h4>
            <p class="info">La propiedad .source devuelve la expresión regular sin las banderas empleadas.` +
            newline + `En lo que respeta a toString(), devuelve íntegra la expresión, banderas incluidas.</p>
            <ol class="info">
                <li>Podemos usar .source así:
                </li>
    ...
    let createExercise = function (fragment) {
        ...
        let resultado1 = miPrimeraRegex.source;
        let resultado2 = miPrimeraRegex.toString();

        paragraph.innerHTML = "Testeando el uso de source: " + resultado1 + newline + newline + "Testeando el uso de toString(): " + resultado2 + newline;
