/**
 * Analiza el siguiente enlace Javascript Set vs. Array performance 
 * y responde a las siguientes preguntas con respecto al rendimiento:
 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado collections en JS.<br/>Ejercicio 7 ';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `
                <h4>7.Analiza el siguiente enlace Javascript Set vs.Array performance ` + newline +`
                    y responde a las siguientes preguntas con respecto al rendimiento: `+ newline + newline +`
                    Al añadir elementos.Métodos utilizados.`+ newline +` 
                    Al modificar elementos.Métodos utilizados. `+ newline +`
                    Al eliminar elementos.Métodos utilizados.`+ newline +` 
                </h4>
        `;
    ...
    let createExercise = function (fragment) {
        ...
        `
            <p class='info2'>
                Al añadir elementos.Métodos utilizados.`+ newline +`
                Array.push(), es más rápido.`+ newline +`  
                Set.add, es más lento.`+ newline + newline +` 
                Al modificar elementos.Métodos utilizados. `+ newline +`
                Array.for(), es más rápido. `+ newline +`
                Set.forOf(), es más lento. `+ newline + newline +`
                Al eliminar elementos.Métodos utilizados.`+ newline +`
                Array.slice(), es mucho más lento.`+ newline +` 
                Set.delete(), es mucho más rápido.`+ newline +`
            </p>
    `;
