 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado collections en JS.<br/>Ejercicio 13 ';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `
                <h4> 13. Responde verdadero falso:
                    <ol class="info">
                        <li>Tanto WeakSet como Set almacenan valores únicos</li>
                        <li>WeakSet sólo almacena Objetos</li>
                        <li>La estructura Set autoelimina los objetos que no tienen referencia </li>
                    </ol>
                </h4>
        `;
    ...
    let createExercise = function (fragment) {
        ...
        `
            <h4> 13. Responde verdadero falso:
                <ol class="info2">
                    <li class="info">Tanto WeakSet como Set almacenan valores únicos: Verdadero</li>
                    <li class="info">WeakSet sólo almacena Objetos: Verdadero</li>
                    <li class="info">La estructura Set autoelimina los objetos que no tienen referencia: Falso</li>
                </ol>
            </h4>
    `;
