/**
 * 9. Entrega un código (debidamente comentado) donde demuestres 
 * los apartados del ejercicio anterior sobre la collection WeakSet. 
 ...
 */
{
	...
	let createPage = function() {
		...
		h2.innerHTML = 'Listado collections en JS.<br/>Ejercicio 9 ';
	...
	let createDefinans = function(fragment) {
		...
		firstParagraph.innerHTML = `
                <h4>9.Entrega un código (debidamente comentado) donde demuestres los apartados del 
                ejercicio anterior sobre la collection WeakSet.<br> 
	...
	let createExercise = function(fragment) {
		...
		/**
         * Constructor del Weakset, admite como parámetros un array de objetos: 
         */
		let constructor = new WeakSet([ obj1, obj2, obj3 ]);
		...
		weakSetAdd.add(obj4);
		weakSetAdd.add(obj5);
		console.log('WeakSet add() -> ' + weakSetAdd);

		/**
         * Usando delete para eliminar un elemento.
         */
		let weakSetDelete = new WeakSet();
		let obj6 = {
			nombre: 'Angelo',
			apellido1: 'Barbara',
			apellido2: ''
		};
		weakSetDelete.add(obj6);
		resultado = weakSetDelete.delete(obj6);
		console.log('WeakSet delete() -> ' + resultado);

		/**
         * Usando has para buscar un elemento.
         */
		let weakSetHas = new WeakSet();
		let obj7 = { nombre: 'benito' };
		weakSetHas.add(obj7);
		resultado = weakSetHas.has(obj7);
