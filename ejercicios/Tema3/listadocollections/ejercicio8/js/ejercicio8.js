 ...
 */
{
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            ` <h4>8. Responde con respecto a WeakSet:</h4>
            <ol class="info">
                <li class="info">Un conjunto de elementos de tipo:<br>
                Permite almacenar y mantener objetos débilmente en una colección.
                </li><br> 
                <li class="info">Constructor admite como parámetro:<br>
                    Iterable: Si un objeto iterable se para como parámetro, todos sus elementos se añadirán al nuevo WeakSet.
                    Null es tratado como undefined.
                </li><br>
                <li class="info">Métodos para añadir:<br>
                    add(value): Agrega un nuevo elemento con el valor dado al objeto WeakSet.
                </li><br>  
                <li class="info">Métodos para eliminar:<br>
                    delete(value): Elimina el elemento asociado al valor.<br>
                    Después WeakSet.prototype.has devolverá false.
                </li><br>  
                <li class="info">Métodos para buscar:<br>
                    has(value): Devuelve un boolean que indica si un elemento está presente con el valor dado en el objeto WeakSet o no.
                </li><br>  
                <li class="info">Número de elementos:<br>
                </li><br>     
                <li class="info">Si dos elementos son iguales:<br>
                Un objecto en WeakSet solo puede ser agregado una vez; Esto quiere decir que es unico en la colección WeakSet.
                </li><br>  
