 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado date en JS.<br/>Ejercicio 3 ';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `
                <h4>3. Indica el formato del parámetro cadena del método Date.parse().</h4>
                <p class="info">
                Transforma la cadena pasada al tiempo que le corresponde en milisegundos desde el 1 de enero del 1970 hasta la fecha indicada.
        El formato es el siguiente: Date.parse("mes d, yyyy"); Mes en inglés y primera letra en mayúscula.s.
                </p>
        `;
    ...
    let createExercise = function (fragment) {
        ...
        let dateParse = Date.parse("November 7, 2018");

        let text = document.createTextNode("Date.parse('November 7, 2018'); -> " + dateParse);
