 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado date en JS.<br/>Ejercicio 2 ';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `
                <h4>2. Indica la utilidad de Date.now();</h4>
                <p class="info">Date.now() indica el momento actual en milisegundos, calculado desde el 1 de Enero de 1970
                </p>
        `;
    ...
    let createExercise = function (fragment) {
        ...
        let resultado = document.createTextNode("Date.now(): " + dateNow);
