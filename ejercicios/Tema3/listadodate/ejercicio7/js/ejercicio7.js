/**
 * 7. Implementa el método diaDeLaSemana() que devuelva 'lunes, martes... domingo' del día actual 
 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado date en JS.<br/>Ejercicio 7 ';
    ...
    let createDefinans = function (fragment) {
        ...
        firstParagraph.innerHTML =
            `
                <h4>7. Implementa el método diaDeLaSemana() que devuelva 'lunes, martes... domingo' 
                del día actual o de la fecha indicada (similar al constructor).</h4>
        `;
    ...
    let createExercise = function (fragment) {
        ...
        paragraph.innerHTML = "Hoy es: " + diaDeLaSemana(fechaActual.getFullYear(), fechaActual.getMonth(), fechaActual.getDay(), fechaActual.getHours(), 0, 0);
