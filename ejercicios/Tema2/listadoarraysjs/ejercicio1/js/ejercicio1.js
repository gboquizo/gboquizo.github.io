 ...
 */
{
    ...
    let createPage = function () {
        ...
        h2.innerHTML = 'Listado arrays en JS.<br />Ejercicio 1 ';
    ...
    let createDefinans = function (fragment) {
        ...
        h4.innerHTML = '1.Indica los tres argumentos del método forEach a un array.<br>Demuestra su uso mediante un ejemplo.';

        let firstParagraph = document.createElement('p');
        firstParagraph.className = 'info';
        firstParagraph.textContent = 'Los tres argumentos del forEach son:';

        let secondParagraph = document.createElement('p');
        secondParagraph.className = 'info';
        secondParagraph.textContent = 'El foreach en JavaScript tiene el siguiente uso:';

        let definans = ['El valor del elemento', 'El índice del elemento', 'El array que se está recorriendo'];
        ...
        let definans2 = [
            "Definimos un array con algunos elementos: array = ' + JSON.stringify(array)",
            'Usamos el forEach de la siguiente forma:',
            'array.forEach(element, index, array)&nbsp&nbsp{',
            '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspaddElement "(Array[" + index + "] = " + element + array =' +
    ...
    let createExercise = function (fragment) {
        ...
        paragraph.append('let array = ' + JSON.stringify(array) + ';');
