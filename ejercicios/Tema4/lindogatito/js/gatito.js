{
    ...
    let generarTabla = function () {
        return '<table>' +
            '<tr><td><p>Nombre: </p></td><td><p>' + document.gato.nombre + '</p></td></tr>' +
            '<tr><td><p>Raza: </p></td><td><p>' + document.gato.raza + '</p></td></tr>' +
            '<tr><td><p>Edad: </p></td><td><p>' + document.gato.edad + '</p></td></tr>' +
            '<tr><td><p>Peso: </p></td><td><p id="p">' + obtenerPeso(document.gato.raza) + ' Kg</p></td></tr>' +
            '<tr><td><p>Estado: </p></td><td><p id="estado">' + document.gato.estado + '</p></td></tr>' +
            '</table>';
    }
